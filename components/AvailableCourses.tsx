  ...
  return (
    <section className="card card-pad">
      <header className="mb-3 flex items-center justify-between">
        <h3 className="text-base font-semibold tracking-tight">Available next term</h3>
      ...
      {codes.length === 0 ? (
        <p className="text-sm text-slate-500">
          ...
          <span className="font-mono">CSCE 1030</span> or <span className="font-mono">MATH 1710</span> to begin.
        </p>
      ) : (
